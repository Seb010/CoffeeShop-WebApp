...
public class ProductsController implements Serializable {
    ...
    private ProductsJpaController jpaController = null;
    ...
    private ProductsJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new ProductsJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getProductsCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findProductsEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getProductsCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findProductsEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findProductsEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findProductsEntities(), true);
    }
    ...
    public static class ProductsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findProducts(getKey(value));
        }
